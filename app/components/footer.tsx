...
const socialLinks = [
  ...
  { name: 'x', url: 'https://x.com/akhilathuluri1', icon: SiX },
  { name: 'instagram', url: 'https://www.instagram.com/athuluriakhil/', icon: SiInstagram },
  { name: 'github', url: 'https://github.com/akhilathuluri', icon: SiGithub },
  { name: 'linkedin', url: 'https://www.linkedin.com/in/athuluriakhil/', icon: SiLinkedin },
  { name: 'youtube', url: 'https://www.youtube.com/c/Akhiltechchannel89131', icon: SiYoutube },
]
    ...
    <footer className="mb-16">
      <ul className="mt-8 flex flex-row space-x-4">
        {socialLinks.map((link) => (
          <li key={link.name}>
            <a
              className="flex items-center transition-all footer-link"
      ...
      <p className="mt-8 text-sm" style={{ color: 'var(--text-tertiary)' }}>
        © {new Date().getFullYear()} MIT Licensed | find code <a 
          className="underline underline-offset-4" 
          rel="noopener noreferrer" 
          aria-label={"source-code"} 
          target="_blank" 
          href="https://github.com/akhilathuluri/portfolio-v3"
          style={{ textDecorationColor: 'var(--border-hover)' }}
        >here</a> | built by <a 
          className="underline underline-offset-4" 
          rel="noopener noreferrer" 
          aria-label={"athuluri-akhil"} 
          target="_blank" 
          href="https://athuluriakhil.vercel.app"
          style={{ textDecorationColor: 'var(--border-hover)' }}
        > athuluri akhil</a>
      </p>
    </footer>
